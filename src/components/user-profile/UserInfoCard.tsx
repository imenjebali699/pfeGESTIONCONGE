...
import ComponentCard from "../common/ComponentCard"; // Ajusté le chemin pour correspondre à la structure du dossier
...
export default function UserInfoCard() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="order-3 xl:order-2">
              ...
              <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                <p className="text-sm text-gray-500 dark:text-gray-400">Informatique</p>
        ...
        <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6 text-center">
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">Imen</p>
            </div>

            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Prénom</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">Jbali</p>
            </div>

            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Poste</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">RH</p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">10/05/2023</p>
            </div>

            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Email</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">rh@example.com</p>
            </div>
          ...
          {/* Bouton Modifier aligné au centre */}
      ...
      <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] m-4 text-center">
        <div className="relative w-full p-4 overflow-y-auto bg-white no-scrollbar rounded-3xl dark:bg-gray-900 lg:p-11">
          <div className="px-2 pr-14">
            <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">Modifier</h4>
          </div>
          ...
          <form className="flex flex-col items-center">
            <div className="px-2 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                <div>
                  <Label>Email</Label>
                  <Input type="email" defaultValue="ijebali95@gmail.com" className="text-center" />
                </div>

                <div>
                  <Label>Mot de passe</Label>
                  <Input type="password" defaultValue="imen123654" className="text-center" />
                </div>
              </div>
            </div>
