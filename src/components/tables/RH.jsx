...
export default function RhComponent() {
  ...
  return (
    <div className="p-5">
      <h1 className="text-2xl font-semibold text-gray-800">Tableau de bord - Ressources Humaines</h1>
      <p className="mt-2 text-gray-600">
        Gestion des congés et des employés du département des Ressources Humaines.
      </p>
      ...
      <div className="mt-6 space-y-3">
        <Link href="/basic-tables/departement/rh/rapport" passHref>
